  ...
  <div class="Sa-Rang">
    <!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Sa-Rang</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="/assets/img/cartoonme.png" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">SA-RANG</h1>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="https://github.com/Bulldog-304/">
                    ...
                    <div class="col-lg-4 mr-auto">
                     ...
                     <!-- About Section Button-->
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="https://youtube.com/sarang5">
                        <i class="fab fa-fw fa-youtube mr-2"></i>
                        Get Entertained!
                    </a>
                </div>
                      </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright © ImSarang.com 2020</small></div>
        </div>
